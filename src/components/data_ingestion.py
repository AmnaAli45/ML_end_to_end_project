...
class DataIngestionCoding:
    ...
    # 2. train data
    # 3. test data
    train_data_path = os.path.join("artifacts","train.csv") # it will create artifacts folder and train.csv file inside it  
    test_data_path = os.path.join("artifacts","test.csv") # creates test.csv file inside artifacts
    raw_data_path = os.path.join("artifacts","raw.csv") # creates raw.csv file inside artifacts
